...
public class ConfigStore {
    ...
    public static void load() {
        ...
        try (FileInputStream fis = new FileInputStream(file)) {
            ...
            parse(props, "security.session_expiry", config::setSessionExpiryTime, Integer::parseInt);
    ...
    public static void save() {
        ...
        props.setProperty("security.session_expiry", String.valueOf(config.getSessionExpiryTime()));
        ...
        props.setProperty("device.name", config.getdeviceName());
        props.setProperty("network.discovery", String.valueOf(config.isDiscoveryEnabled()));
        props.setProperty("quick.expire_hours", String.valueOf(config.getQuickShareExpireHours()));
